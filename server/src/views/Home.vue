<template>
    <div @show="funcA" class="home">
        ...
        <div class="content">
            <div class="content_block" v-for="(msg,index) in msgs" :key="index">
                <div class="content_tags">
                    <h2 v-for="(tag,cindex) in [msgs[index].tags]" :key="cindex">
                        {{tag}}
                    </h2>
                </div>
...
<style>
    ...
    .content .content_block .content_tags{
        display: flex;
        width:100%;
        margin-bottom:15px;
    ...
    .content .content_block .content_tags h2{
